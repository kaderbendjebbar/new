...
function facturesSonelgaz_E01(D) {
  ...
  const TotalHT = MTR1Elect + MTR2Elect + D.PMDR - 85.5; //262.2
  ...
  Resultats[11] = Math.trunc((D.PMDR - 85.5) * 100) / 100;
...
function facturesSonelgazMenage(D) {
  ...
  const TotalHTTR12Elect = MTR1Elect + MTR2Elect + 0.003;
  const TotalHTTR34Elect = MTR3Elect + MTR4Elect + 0.002;
  const TotalHTTR12Gaz = MTR1Gaz + MTR2Gaz + 0.003;
  const TotalHTTR34Gaz = MTR3Gaz + MTR4Gaz + 0.002;

  const TotalHTElect =
    Math.trunc((TotalHTTR12Elect + TotalHTTR34Elect) * 100) / 100;
  const TotalHTGaz = Math.trunc((TotalHTTR12Gaz + TotalHTTR34Gaz) * 100) / 100;
  ...
  Resultats[9] = TR4Gaz;
  Resultats[10] = TotalHTGaz;
  const xxx = D.PMDR + 0.00001;
  Resultats[11] = D.PMDR; //Math.trunc((xxx * 100) / 100);
...
function facturesSonelgazCommerciale(D) {
  ...
  const TotalHTTR23Elect = MTR2Elect + MTR3Elect + 0.005;
  const TotalHTTR1Gaz = MTR1Gaz;
  const TotalHTTR23Gaz = MTR2Gaz + MTR3Gaz + 0.005;

  const TotalHTElect =
    Math.trunc((TotalHTTR1Elect + TotalHTTR23Elect) * 100) / 100;
  const TotalHTGaz = Math.trunc((TotalHTTR1Gaz + TotalHTTR23Gaz) * 100) / 100;
  ...
  Resultats[9] = TR3Gaz;
  Resultats[10] = TotalHTGaz;
  Resultats[11] = Math.trunc(D.PMDR * 100) / 100;
  Resultats[12] = TotalHT;
  Resultats[13] = TVA9;
  Resultats[14] = TVA19;
  Resultats[15] = TotalTVA;
...
function createButton() {
  var btn = document.createElementNS("TR", "TH"); // Créer un élément <button>
  var t = document.createTextNode("CLICK ME"); // Créer un noeud textuel
  btn.appendChild(t); // Ajouter le texte au bouton

  var sss = document.querySelector("#QE");
  sss.insertAdjacentElement("beforebegin", btn);
  document.body.appendChild(btn); // Ajoute la balise <button> à la balise <body>
  console.log("yes ok");
}
function insertElement() {
  var targetElement = document.getElementById("05");
  var childd = document.getElementById("QE");
  var newTH = document.createElement("th");
  var newTR = document.createElement("tr");
  var newInput = document.createElement("input");
  // construct newTH
  const node = document.createTextNode("New Created");
  newTH.appendChild(node);
  //construct newInput
  newInput.setAttribute("id", "hello");
  ...
  childd.parentNode.parentNode.insertBefore(newTR, childd.parentNode);
}

function addElectricite(Categorie) {
  document.querySelector("#Categorie").value = Categorie;
  if (Categorie == "54M" || Categorie == "54NM") {
    ...
    document.querySelector("#QE").innerHTML = "";
    document.querySelector("#QElect").placeholder = "";
  }
}

document.addEventListener("DOMContentLoaded", () => {
  document.getElementById("Tarif").onchange = function () {
    const Categorie = this.value;
    addElectricite(Categorie);
  };

  document.getElementById("pmdd").onchange = function () {
    document.querySelector("#PMD_").value = this.value;
  };
  ...
  document.querySelector("form").onsubmit = () => {
    ...
    const PMD = document.querySelector("#PMD_").value;
...
function alongelist() {
  childd1 = document.createElement("button");
  childd1.setAttribute("value", "10");
  childd1.setAttribute("class", "Hllo1");
  childd1.innerHTML = "Button1";

  separation = document.createElement("br");
  childd2 = document.createElement("button");
  childd2.setAttribute("value", "11");
  childd2.setAttribute("class", "Hllo2");
  childd2.innerHTML = "Button2";

  document.body.appendChild(separation);
  document.body.appendChild(childd1);
  // document.body.appendChild(separation);
  document.body.appendChild(separation);
  document.body.appendChild(childd2);
  // document.body.appendChild(separation);
}
